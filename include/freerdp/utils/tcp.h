...
FREERDP_API int freerdp_tcp_read(freerdp* instance, int sockfd, uint8* data, int length);
FREERDP_API int freerdp_tcp_write(freerdp* instance, int sockfd, uint8* data, int length);
