...
FREERDP_API void tls_print_certificate_error(rdpTls* tls, char* hostname, char* fingerprint, char *hosts_file);
FREERDP_API void tls_print_certificate_name_mismatch_error(rdpTls* tls, char* hostname, char* common_name, char** alt_names, int alt_names_count);
